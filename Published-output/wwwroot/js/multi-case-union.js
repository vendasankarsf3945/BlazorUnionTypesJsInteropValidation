...
export async function callCSharpWithApiResponse() {
    // Send SuccessResponse case — C# receives as ApiResponse union
    ...
    try {
        const returned = await DotNet.invokeMethodAsync("UnionInteropValidation.Server", "HandleApiResponseFromJS", payload);
