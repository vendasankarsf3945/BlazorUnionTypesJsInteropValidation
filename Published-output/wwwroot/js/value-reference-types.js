...
export async function callCSharpWithValueType() {
    ...
    try {
        const returned = await DotNet.invokeMethodAsync("UnionInteropValidation.Server", "HandleValueTypeFromJS", payload);
...
export async function callCSharpWithReferenceType() {
    ...
    try {
        const returned = await DotNet.invokeMethodAsync("UnionInteropValidation.Server", "HandleReferenceTypeFromJS", payload);
